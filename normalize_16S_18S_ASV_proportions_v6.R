...
#Purpose: normalize raw counts of 16S and 18S ASVs by doubling counts of euks and dividing counts of proks and euks by the % passing DADA2, then converting to proportions.
#This returns a file with ASV relative abundances out of (16S + 18S).
...
print("Script complete! Please find the relative abundances of your 16S and 18S ASVs (out of (16S + 18S) sequences) in this directory, the file is called 'ASV_proportions_16S_18S.tsv.' 
Thank you!")
