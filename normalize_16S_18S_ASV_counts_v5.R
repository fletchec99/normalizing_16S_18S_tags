...
#This returns a file with normalized sequence counts, not proportions.
...
print("Script complete! Please find your normalized, merged 16S+18S abundance counts in this directory; the file is called 'normalized_merged_16S_18S.tsv'. Note that this file contains normalized sequencing counts, not proportions! Next run Jesse's 'transform-ESV-tsv-to-proportions.py' script on this file to (you guessed it!) transform the counts to proportions.")
